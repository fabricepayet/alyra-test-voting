...
contract("Voting", (accounts) => {
  ...
  const END_PROPOSAL_REGISTERING_REVERT =
    "Registering proposals havent started yet";
  const START_PROPOSAL_REGISTERING_REVERT =
  ...
  describe("Getters", () => {
    describe("GetVoter", () => {
      ...
      it("should revert if the caller is not a voter", async () => {
        const getVoterPromise = votingInstance.getVoter.call(owner, {
          from: account2,
        });
        await expectRevert(getVoterPromise, ONLY_VOTER_REVERT);
      });

      it("should return a non registered voter", async () => {
    ...
    describe("getOneProposal", () => {
      ...
      it("should revert if the caller is not a voter", async () => {
        const getOneProposalPromise = votingInstance.getOneProposal.call(0, {
          from: account2,
        });
      ...
      it("should return the correct proposal", async () => {
        ...
        // The id is 1 because we already have the GENESIS proposal in the array
  ...
  describe("RegisteringVoters", () => {
    ...
    describe("checks", () => {
      ...
      it("should revert when calling endProposalsRegistering", async () => {
        const endProposalsRegisteringPromise =
          votingInstance.endProposalsRegistering();
        await expectRevert(
          endProposalsRegisteringPromise,
          END_PROPOSAL_REGISTERING_REVERT
        );
      });
    ...
    describe("addVoter", () => {
      ...
      it("should prevent adding voter if not owner", async () => {
        const addVoterPromise = votingInstance.addVoter(account2, {
          from: account2,
        });
    ...
    describe("startProposalsRegistering", () => {
      ...
      it("should emit an event", async () => {
        ...
        expectEvent(event, expectedEvent, {
          previousStatus: BN(0),
          newStatus: BN(1),
        });
      });

      it("should change the worflowStatus", async () => {
        await votingInstance.startProposalsRegistering();
        const workflowStatus = await votingInstance.workflowStatus();
        expect(workflowStatus).to.be.bignumber.equal(BN(1));
      });
    });
  });
  ...
  describe("ProposalsRegistrationStarted", () => {
    describe("checks", () => {
      ...
      it("should revert when calling startProposalsRegistering", async () => {
        const startProposalsRegisteringPromise =
          votingInstance.startProposalsRegistering();
        await expectRevert(
          startProposalsRegisteringPromise,
          START_PROPOSAL_REGISTERING_REVERT
        );
      });
    ...
    describe("addProposal", () => {
      ...
      it("should prevent adding a proposal if the caller is not a voter", async () => {
        const addProposalPromise = votingInstance.addProposal("description", {
          from: account3,
        });
    ...
    describe("endProposalsRegistering", () => {
      ...
      it("should change the worflowStatus", async () => {
        await votingInstance.endProposalsRegistering();
        const workflowStatus = await votingInstance.workflowStatus();
        expect(workflowStatus).to.be.bignumber.equal(BN(2));
      });
    });
  });
  ...
  describe("ProposalsRegistrationEnded", () => {
    ...
    describe("startVotingSession", () => {
      ...
      it("should change the worflowStatus", async () => {
        ...
        const workflowStatus = await votingInstance.workflowStatus();
        expect(workflowStatus).to.be.bignumber.equal(BN(3));
      });
    });
  });
  ...
  describe("VotingSessionStarted", () => {
    ...
    describe("setVote", () => {
      ...
      it("should update the voter properly when voting", async () => {
        ...
        expect(voterUpdated.votedProposalId).to.be.bignumber.equal(
          BN(proposalId)
        );
      });
    ...
    describe("endVotingSession", () => {
      ...
      it("should change the worflowStatus", async () => {
        ...
        const workflowStatus = await votingInstance.workflowStatus();
        expect(workflowStatus).to.be.bignumber.equal(BN(4));
      });
    });
  });
  ...
  describe("VotingSessionEnded", () => {
    ...
    describe("tallyVotes", () => {
      ...
      it("should change the worflowStatus", async () => {
        await votingInstance.tallyVotes();
        const workflowStatus = await votingInstance.workflowStatus();
        expect(workflowStatus).to.be.bignumber.equal(BN(5));
      });
    });
  });
